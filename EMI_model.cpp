...
//  ("input",                    inputfile,                           "./input/robin_combi_domi_smaller.vtu","subdomain definition")
  ...
  ("run_implicit_CG_SDC_BDDC_all_collocation_once", run_implicit_CG_SDC_BDDC_all_collocation_once_update,            true, "run linearly semi-implicit method + CG + BDDC + SDC " )
  ...
  ("sweeps",                   options.minSweeps,                   2,  "minimal number of SDC sweeps")
  ("maxSweeps",                options.maxSweeps,                   2,  "maximal number of SDC sweeps")
