                                                            ...
                                                            bool BDDC_SDC_verbose)
{
  ...
  for (steps=0; !done && steps<maxSteps; ++steps) // maxSteps
  {
    ...
    do
    {
      ...
      sweepNorm_bddc.push_back( sdcIterationStepBDDC_smallest_collocation(reassemble, BDDC_SDC_with_initial, BDDC_verbose, BDDC_SDC_verbose, sweep, cg_solver,iter_cg_with_bddc,tol,matlab_dir,
                                                            ifa,
                                                            n_subdomains,
                                                            grid,
                                                            Shat,
